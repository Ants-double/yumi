namespace LDHExcelAddIn
{
    partial class RibbonTest : Microsoft.Office.Tools.Ribbon.RibbonBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupSum = this.Factory.CreateRibbonGroup();
            this.SelectAir = this.Factory.CreateRibbonCheckBox();
            this.AddSum = this.Factory.CreateRibbonButton();
            ...
            this.GroupTable.Items.Add(this.button1);
            ...
            this.DealColor.Groups.Add(this.groupSum);
            ...
            // groupSum
            // 
            this.groupSum.Items.Add(this.SelectAir);
            this.groupSum.Items.Add(this.AddSum);
            this.groupSum.Label = "求和";
            this.groupSum.Name = "groupSum";
            // 
            // SelectAir
            // 
            this.SelectAir.Label = "只计算选中区域";
            this.SelectAir.Name = "SelectAir";
            this.SelectAir.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.SelectAir_Click);
            // 
            // AddSum
            // 
            this.AddSum.Label = "除第一列求和";
            this.AddSum.Name = "AddSum";
            this.AddSum.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.AddSum_Click);
            // 
            // button1
            // 
            ...
            this.groupSum.ResumeLayout(false);
            this.groupSum.PerformLayout();
        ...
        internal Microsoft.Office.Tools.Ribbon.RibbonGroup groupSum;
        internal Microsoft.Office.Tools.Ribbon.RibbonButton AddSum;
        internal Microsoft.Office.Tools.Ribbon.RibbonCheckBox SelectAir;
